...
public class VisitaController {
	...
	@PostMapping
	public boolean insVisita(@RequestBody Visita objStud) {
		objStud.genCodice();
		objStud.genSecret();
...
//			return null;
	...
	@PutMapping("/{varID}")
	public boolean modVisita(@PathVariable Integer varID, @RequestBody Visita objStu) {
		if (varID == null || varID < 0)
			return false;
